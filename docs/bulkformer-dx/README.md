...
- `anomaly`: Monte Carlo masking residual ranking is implemented; optional head training and cohort calibration are still pending.
...
The preprocessing workflow and anomaly ranking workflow are now implemented with unit tests and working CLIs. The remaining command groups stay scaffolded for follow-up rollout steps.
